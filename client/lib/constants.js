...
export const DOM = {
    ...
    get countdownNumber() { return document.getElementById('countdown-number'); },
    get countdownRing() { return document.getElementById('countdown-ring'); },
    get countdownSvg() { return document.querySelector('.countdown-svg'); },
